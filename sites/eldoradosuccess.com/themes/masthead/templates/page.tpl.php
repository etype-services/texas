...
<!-- <li><a class="twitter" href="<?php echo $twitter ?>"></a></li> 
          <li><a class="facebook" href="<?php echo $facebook ?>"></a></li> -->
           <li><a class="facebook" href="https://www.facebook.com/pages/Eldorado-Success-Newspaper/112385915456963"></a></li> 
        </ul>
      </div>           
    </nav>      
  <?php endif; ?>    
...
<!-- All Hail the Footer -->
  <div class="footer-wrapper clearfix"><div class="footer-wrapper-inner">
    <footer id="footer" class="<?php echo $grid_full_width ?>">
     ...
     <!--The following line cannot be changed or removed without violating the terms and service of Surf New Media. Site will be shut down within 24 hours of removal -->   <span style="font-size:0.8em;"><p><a href="http://www.etypeservices.com"><img align="middle" alt="An eTypeservices Web Site" height="66" src="/sites/default/files/eTYPEServices_footer_logo.jpg" title="An eTypeservices Web Site" width="100" /></a></p></span>
    </footer><!-- /footer -->
  </div></div>
