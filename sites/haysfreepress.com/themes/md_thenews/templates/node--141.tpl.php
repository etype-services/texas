...
?>
<form name="planform" method="POST" action="/node/142"
    ...
    <div class="header1">
      ...
      <div class="headerdown">
        <div class="headerdl" style="height:200px;">
          ...
          <img src="http://www.haysfreepress.com/sites/default/files/logo.png"
      ...
      <p style="text-align: justify;margin-right: 41px;margin-top: 13px;">
        ...
        <strong>Already a print subscriber? <a
            href="http://etypeservices5.net/hays/node/143" style="color:red">Fill
            out this form</a> to activate your digital subscription. Once your
          print subscription is verified, your user account will be
          enabled.</strong>
      </p>
      ...
      <div class="content1">
        <div class="left">
          ...
          while ($response->GetSubsciptionPlanResult->PlanDetails[$i]->ID > 0) {
            ...
            echo "&nbsp";
            echo "&nbsp";
            echo $response->GetSubsciptionPlanResult->PlanDetails[$i]->PeriodType; ?> Subscription for $ <?php echo "&nbsp";
            echo $response->GetSubsciptionPlanResult->PlanDetails[$i]->Price; ?>
            <br>
