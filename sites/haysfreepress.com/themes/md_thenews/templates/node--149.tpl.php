...
if (isset($_POST['send'])) {
  ...
  if ($response12->GetPublicationIDResult == -9) {
    ...
    if ($response12->GetPublicationIDResult == 200) {
...
<form action="" method="post">
  ...
  <input type="submit" name="send" value="Submit!"
         style="background-color: gainsboro;border-radius: 4px;width: 93px;height: 28px;border: 1px solid #CCC;text-decoration: none;color: #000;text-shadow: white 0 1px 1px;padding: 2px;"></p>
</form>
