        ...
        <div style="margin-left:30px">        
           ...
           <p> This is where we will deliver the latest e-Edition of the newspaper.</p>
            ...
            <div>
               ...
               <input type="password" name="password"  pattern=".{6,}" class="txt" placeholder="Min. 6 character" required="required" /> 
            </div>
             <div>
                <label for="cpassword">Confirm Password:</label>
 
                 <input type="password" name="cpassword"  pattern=".{6,}"  placeholder="Confirm Password" class="txt" oninput="check(this)" required="required" />
            </div></div><br/>
            <br/>
