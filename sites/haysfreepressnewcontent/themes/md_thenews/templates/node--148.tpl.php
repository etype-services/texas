      ...
      <form name="change password" method="POST" action="">
        ...
        <table>
          <tr>
            ...
            <td><input type="text" name="name"  value="<?php echo $user->name;?>" placeholder="User Name" readonly>
            </td></tr>
            <td>Old Password
            </td>
            ...
            <td><input type="password" id="confirmpassword"  name="confirmpassword"  pattern=".{6,}" oninput="check(this)" placeholder="Min. 6 Character">
            </td>
          </tr>
        </table>  
